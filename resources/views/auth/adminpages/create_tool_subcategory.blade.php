            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Add New Tool Sub Category</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create new sub category here</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    <form id="create-tool-category-form" action="{{ route('save_tools_subcategory') }}" method="post"> 
                                    @csrf
                                        <!--  action="#" method="post" -->
                                        <div class="row">
                                            <div class="col-xl-10">
